...
public sealed record PrintResult(string PrinterName, string JobId);
public sealed record PrintOptions(bool FitToPage = true, int Copies = 1, string? Media = null);
public sealed record PrinterInfo(string Name, string Uri, string Status, bool IsDefault, bool IsUSB);
